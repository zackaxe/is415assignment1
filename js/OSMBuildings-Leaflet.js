(function(ca) {
    ...
    var u = Math,
        ...
        I = function(b) {
            ...
            d.parse = function(a) {
                ...
                a = ("" + a).toLowerCase();
                a = c[a] || a;
                if (m = a.match(/^#(\w{2})(\w{2})(\w{2})$/)) b = parseInt(m[1], 16), d = parseInt(m[2], 16), h = parseInt(m[3], 16);
                else if (m = a.match(/rgba?\((\d+)\D+(\d+)\D+(\d+)(\D+([\d.]+))?\)/)) b = parseInt(m[1], 10), d = parseInt(m[2], 10), h = parseInt(m[3], 10), k = m[4] ? parseFloat(m[5]) : 1;
                else return;
        ...
        Ja = function() {
            ...
            function a(a, b) {
                var c, d, f, s, D = 0,
                    p, n;
                p = 0;
                for (n = a.length - 3; p < n; p += 2) c = a[p], d = a[p + 1], f = a[p + 2], s = a[p + 3], D += c * s - f * d;
        ...
        F = {
                ...
                for (c[d] = c[f] = 1; f;) {
                    ...
                    for (e = d + 1; e < f; e++) {
                        ...
                        var p = b[2 * e + 1],
                            ...
                            v = w - r,
                            x = void 0;
                        if (0 !== t || 0 !== v) x = ((h - q) * t + (p - r) * v) / (t * t + v * v), 1 < x ? (q = u, r = w) : 0 < x && (q += t * x, r += v * x);
                        t = h - q;
                        v = p - r;
                        h = t * t + v * v;
                        h > g && (k = e, g = h)
            ...
            scale: function(b) {
                ...
                if (!(a.minHeight > ga) && (a.footprint = this.getPixelFootprint(b.footprint), a.footprint)) {
                    ...
                    var n;
                    b.wallColor && (n = I.parse(b.wallColor)) && (n = n.alpha(C), a.altColor = "" + n.lightness(0.8), a.wallColor = "" + n);
                    ...
                    if (!(a.height +
                            a.roofHeight <= a.minHeight)) return a
                }
            },
            set: function(b) {
                this.isStatic = !0;
        ...
        Z = {
            draw: function(b, a, c, d, f, e, g, h) {
                var k, m = this._extrude(b, a, d, f, e, g),
                    l = [];
                if (c)
        ...
        w = {
            draw: function(b, a, c, d, f, e, g, h, k) {
                ...
                (m = this._tangents(a,
                    c, f, d)) ? (e = P(m[0].y1 - a.y, m[0].x1 - a.x), m = P(m[1].y1 - a.y, m[1].x1 - a.x)) : (e = 1.5 * E, m = 1.5 * E);
                b.fillStyle = g;
                b.beginPath();
            ...
            shadow: function(b, a, c, d, f, e) {
                ...
                h ? (e = P(h[0].y1 - a.y, h[0].x1 - a.x), g = P(h[1].y1 - a.y, h[1].x1 - a.x), b.moveTo(h[1].x2, h[1].y2), b.arc(f.x, f.y, d, g, e), b.arc(a.x, a.y, c, e, g)) : (b.moveTo(a.x + c, a.y), b.arc(a.x, a.y, c, 0, 2 * E))
            },
            shadowMask: function(b, a, c) {
                var d = a.x - p;
                a = a.y - n;
            ...
            hitArea: function(b, a, c, d, f, e, g) {
                ...
                e ? (g = P(e[0].y1 - a.y, e[0].x1 - a.x), h = P(e[1].y1 - a.y, e[1].x1 - a.x), b.moveTo(e[1].x2,
                    e[1].y2), b.arc(f.x, f.y, d, h, g), b.arc(a.x, a.y, c, g, h)) : (b.moveTo(a.x + c, a.y), b.arc(a.x, a.y, c, 0, 2 * E));
                b.closePath();
                b.fill()
            },
            ...
            render: function() {
                ...
                if (!(x < G || Q || x > this.maxZoom))
                    for (var a, c, d = F.items, f = 0, e = d.length; f < e; f++)
                        if (a = d[f], !(a.height >= this.maxHeight) && (c = a.footprint, V(c))) switch (b.strokeStyle = a.altColor || aa, b.fillStyle = a.roofColor || X, a.shape) {
                            case "cylinder":
                            case "cone":
                            case "dome":
                            case "sphere":
        ...
        z = {
            ...
            render: function() {
                ...
                if (!(!this.enabled || x < G || Q || (a = ja(W + p, fa + n), a = Ha(this.date, a.latitude, a.longitude), 0 >= a.altitude))) {
                    ...
                    d = 0;
                    for (c = a.length; d < c; d++)
                        if (f = a[d], h = f.footprint, V(h) && !f.minHeight) switch (f.shape) {
                            case "cylinder":
                            case "cone":
                            case "dome":
        ...
        Y = {
            ...
            idToColor: function(b) {
                var a = this._idMapping.indexOf(b); - 1 === a && (this._idMapping.push(b), a = this._idMapping.length - 1);
        ...
        $, A = {
            ...
            setSize: function(b, a) {
                for (var c = 0, d = this.items.length; c < d; c++) this.items[c].width = b, this.items[c].height =
                    a
            },
    ...
    t.style = function(b) {
        b = b || {};
        var a;
        if (a = b.color || b.wallColor) H = I.parse(a), ha = "" + H.alpha(C), ba = H.lightness(0.8), aa = "" + ba.alpha(C), O = H.lightness(1.2), X = "" + O.alpha(C);
